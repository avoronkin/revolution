...
$_lang['required'] = 'Разрешить пустые';
...
$_lang['resourcelist_parents_desc'] = 'Список идентификаторов, чтобы выбрать дочерние ресурсы для списка.';
$_lang['resourcelist_where'] = 'Where условие';
$_lang['resourcelist_where_desc'] = 'Объект JSON, с условиями для фильтрации в запросе выводящем список ресурсов. (фильтрация по TV не поддерживается)';
